...
<div class="heading">
<h1 class="mt-3 mb-3">Ladprao - Jatujak - Bangkhen</h1>
</div>
<script>var ll = document.getElementById("s");</script>
</body>
</html>
...
<?php include('server.php');?>
	<?php include('upload.php');?>
		...
		<?php
        $_SESSION['lo'] = 'Sukhumvit';
        $_SESSION['lo'] = 'll';
        $lo = $_SESSION['lo'];
			//Fetching all uploaded posts
            $sql = "SELECT * FROM review WHERE location = '$lo'"; //ไฟล์อื่นทำเหมือนเดิมกับอื่นนี้ แก้แค่ชื่อ //Ladkrabang,Bangna,Ladprao
  ...
  <div class="container" name="show">
    <div class="row">
      <div class="card" name="showcard">
        <div class="card-header" name="showhead">
